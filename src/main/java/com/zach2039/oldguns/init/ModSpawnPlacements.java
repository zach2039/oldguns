...
public class ModSpawnPlacements {
	...
	static {
		...
		SpawnPlacements.register(ModEntities.HARQUEBUSIER_SKELETON.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Monster::checkMonsterSpawnRules);
	}
