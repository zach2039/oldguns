...
import com.zach2039.oldguns.world.level.block.entity.StationaryArtilleryEntity;

import net.minecraft.world.entity.LivingEntity;
import net.minecraft.world.level.Level;

public interface IArtilleryAmmo {
	List<BulletProjectile> createProjectiles(Level worldIn, double x, double y, double z, IArtilleryAmmo stack, StationaryArtilleryEntity stationaryArtilleryEntity, LivingEntity shooter);
