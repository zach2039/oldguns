...
public class ShapelessGunsmithsBenchMortarAndPestleRecipeBuilder extends EnhancedShapelessRecipeBuilder<ShapelessGunsmithsBenchMortarAndPestleRecipe, ShapelessGunsmithsBenchMortarAndPestleRecipeBuilder> {
	...
	public static ShapelessGunsmithsBenchMortarAndPestleRecipeBuilder shapeless(final IItemProvider result) {
	...
	public static ShapelessGunsmithsBenchMortarAndPestleRecipeBuilder shapeless(final IItemProvider result, final int count) {
