 ...
 * @author Choonster
 */
public class ShapedGunsmithsBenchRecipeBuilder<
RECIPE extends ShapedGunsmithsBenchRecipe,
BUILDER extends ShapedGunsmithsBenchRecipeBuilder<RECIPE, BUILDER>
> extends ShapedRecipeBuilder {
	...
	protected final ShapedGunsmithsBenchRecipeFactory<? extends RECIPE> factory;
	protected final List<ResourceLocation> conditions;

	protected ShapedGunsmithsBenchRecipeBuilder(final RecipeCategory recipeCategory, final ItemStack result, final ShapedGunsmithsBenchRecipeFactory<? extends RECIPE> factory) {
	...
	protected ShapedGunsmithsBenchRecipeBuilder(
			final RecipeCategory category,
			final ItemStack result,
			final ShapedGunsmithsBenchRecipeSerializer<? extends RECIPE> serializer
	) {
