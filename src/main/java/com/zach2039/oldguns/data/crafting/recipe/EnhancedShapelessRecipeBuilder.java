...
> extends ShapelessRecipeBuilder {
	...
	protected EnhancedShapelessRecipeBuilder(final RecipeCategory recipeCategory, final ItemStack result, final ShapelessRecipeFactory<? extends RECIPE> factory) {
