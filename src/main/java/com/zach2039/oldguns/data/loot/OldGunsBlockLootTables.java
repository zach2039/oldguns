...
public class OldGunsBlockLootTables extends BlockLootTables {
	...
	protected void addTables() {
		...
		add(ModBlocks.HIGH_GRADE_BLACK_POWDER_BLOCK.get(), (p_124235_) -> {
	         return createSingleItemTableWithSilkTouch(p_124235_, ModItems.HIGH_GRADE_BLACK_POWDER.get(), ConstantRange.exactly(1));
	      });
		dropSelf(ModBlocks.WET_HIGH_GRADE_BLACK_POWDER_BLOCK.get());
		
		add(ModBlocks.MEDIUM_GRADE_BLACK_POWDER_BLOCK.get(), (p_124235_) -> {
	         return createSingleItemTableWithSilkTouch(p_124235_, ModItems.MEDIUM_GRADE_BLACK_POWDER.get(), ConstantRange.exactly(9));
	      });
