...
public class MatchlockLongMusketItem extends FirearmItem implements IFirearm {
	
	private static final MuzzleloadingFirearmAttributes firearmAttributes = OldGunsConfig.SERVER.firearmSettings.matchlockSettings.matchlock_long_musket;
	
	public MatchlockLongMusketItem()
	{		
