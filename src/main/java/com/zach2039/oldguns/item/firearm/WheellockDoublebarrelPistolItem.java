...
public class WheellockDoublebarrelPistolItem extends FirearmItem implements IFirearm {
	
	private static final MuzzleloadingFirearmAttributes firearmAttributes = OldGunsConfig.SERVER.firearmSettings.wheellockSettings.wheellock_doublebarrel_pistol;
	
	public WheellockDoublebarrelPistolItem()
	{		
