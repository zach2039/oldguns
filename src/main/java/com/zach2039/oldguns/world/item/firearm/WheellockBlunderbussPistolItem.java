...
public class WheellockBlunderbussPistolItem extends FirearmItem implements IFirearm {
	...
	private static final MuzzleloadingFirearmAttributes firearmAttributes = OldGunsConfig.COMMON.firearmSettings.wheellockSettings.wheellock_blunderbuss_pistol;
