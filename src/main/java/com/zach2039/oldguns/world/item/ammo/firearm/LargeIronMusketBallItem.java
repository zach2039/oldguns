...
public class LargeIronMusketBallItem extends FirearmAmmoItem implements FirearmAmmo {

	private static final FirearmAmmoAttributes ammoAttributes = OldGunsConfig.SERVER.firearmSettings.ammoSettings.large_iron_musket_ball;
