...
public class WheellockBlunderbussItem extends FirearmItem implements IFirearm {
	
	private static final MuzzleloadingFirearmAttributes firearmAttributes = OldGunsConfig.SERVER.firearmSettings.wheellockSettings.wheellock_blunderbuss;
	
	public WheellockBlunderbussItem()
	{		
