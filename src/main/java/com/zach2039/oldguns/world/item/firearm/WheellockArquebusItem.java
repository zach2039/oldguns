...
public class WheellockArquebusItem extends FirearmItem implements IFirearm {
	
	private static final MuzzleloadingFirearmAttributes firearmAttributes = OldGunsConfig.SERVER.firearmSettings.wheellockSettings.wheellock_arquebus;
	
	public WheellockArquebusItem()
	{		
