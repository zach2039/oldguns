...
public class MessageSyncTileEntityCannonRotation implements IMessage {
	
	BlockPos blockPos;
	float barrelPitch;
	float barrelYaw;
	
	public MessageSyncTileEntityCannonRotation(BlockPos blockPos, float rotationPitch, float rotationYaw)
	{
	...
	public MessageSyncTileEntityCannonRotation()
	{
	}
	...
	public static class HandlerClient implements IMessageHandler<MessageSyncTileEntityCannonRotation, IMessage>
	{
		@Override
		public IMessage onMessage(MessageSyncTileEntityCannonRotation message, MessageContext ctx)
		{
