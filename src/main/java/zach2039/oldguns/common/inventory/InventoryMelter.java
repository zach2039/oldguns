...
import zach2039.oldguns.api.crafting.impl.IMelter;

public class InventoryMelter implements IInventory, IMelter
{
    ...
    public InventoryMelter(Container eventHandlerIn, int width, int height)
    {
