...
public class ItemFlintlockCaliver extends ItemFirearm implements IFirearm
{
	public ItemFlintlockCaliver()
	{
		super("flintlock_caliver");
		setAmmoCapacity(1);
		...
		setEffectiveRangeModifier(ConfigCategoryFirearms.configFlintlockCaliver.baseEffectiveRange);
