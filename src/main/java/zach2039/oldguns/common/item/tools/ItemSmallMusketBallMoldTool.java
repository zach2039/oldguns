...
public class ItemSmallMusketBallMoldTool extends Item
{
	public ItemSmallMusketBallMoldTool()
	{
		setRegistryName(OldGuns.MODID, "small_musket_ball_mold_tool");
		//setUnlocalizedName("small_musket_ball_mold_tool");
		setMaxStackSize(1);
